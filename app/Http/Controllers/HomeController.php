...
class HomeController extends Controller
{
    ...
    public function search(Request $request){
        ...
        return view('pages.result')->with(compact('ten','date','so','desc'));
    }
    public function peak_year(){
        return view('peakYear.input_py');
    }

    public function result_py(Request $request){
        $customer = CustomerModel::where('customer_id',Session::get('customer_id'))->get();
